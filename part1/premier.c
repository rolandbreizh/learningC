/*Ci-dessous, ce sont des directives de préprocesseur. Ces lignes permettent
...
afficher par exemple un message à l'écran.*/

#include <stdio.h>
#include <stdlib.h>

/* Ci-dessous, vous avez la fonction principale du programme, appellé 
texttt{main}.
...
int main()
{
    ...
    return 0; // Le programme renvoie le nombre zéro puis s'arrête. 
}
